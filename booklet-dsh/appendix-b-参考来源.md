...
| 上册第 5 章 | 第 2 关 定界，写不下来的边界等于不存在 |
| 上册第 10 章 | 第 6 关 采用，采用率崩塌的死法 |
| 上册第 14 章 | 经验资产化、三类交付结果的回收 |
| 下册第 1 章 | 底座与现场层的物理边界 |
| 下册第 3 章 | Spec Kit／OpenSpec／Superpowers 各补什么 |
| 下册第 4 章 | 企业集成、客户 IT 部门的话怎么翻 |
| 下册第 5 章 | 换 embedding 模型要全量重建索引 |
| 下册第 8 章 | 部署护栏与可观测性、命令不由你来敲的时候 |
| 下册第 9 章 | 评估的工程实现、验收集三件套 |
| 下册第 12 章 | 信创适配 |
