...
你信的是后者。}{%
本书 §9.0　·　判据定义见上册 §8.2　·　最狠的检验在 §11}{0}}
...
\begin{tikzpicture}[x=1cm,y=1cm]
  \foreach \i/\x/\prt/\nm/\ch in {%
    1/0.00/第一部/{认清\\这件事}/{第 1--3 章},
    2/3.85/第二部/{六道\\关卡}/{第 4--10 章},
    3/7.70/第三部/{中国\\现场}/{第 11--13 章},
    4/11.55/第四部/{从一次成功\\到一套能力}/{第 14--16 章}%
  }{
...
\begin{tikzpicture}[x=1cm,y=1cm,
  ...
  \node[fdcav, anchor=north west, text width=13.9cm] at (0.0,-11.30)
    {① Lab-01 → Lab-10：结构化摄取产物是对账 Agent 的输入（上册第 16 章）\quad
...
% ═══════════════════════════════════════════════════════════════
% 图 30 · 上册第 6 章·技术债四象限，以及 V0 允许硬编码的那一格
...
% ═══════════════════════════════════════════════════════════════
% 图 32 · 上册第 10 章·那条坍塌漏斗，以及影子 AI 造成的低估
...
% ═══════════════════════════════════════════════════════════════
% 图 48 · 下册第 7 章·微调 vs RAG vs Prompt
...
% ═══════════════════════════════════════════════════════════════
% 图 49 · 下册第 8 章·gpu-memory-utilization 是「预留」，不是「上限」
...
% ═══════════════════════════════════════════════════════════════
% 图 51 · 下册第 9 章·三类裁判偏差，以及它们在不同评委上的实测差距
...
% ═══════════════════════════════════════════════════════════════
% 图 52 · 下册第 11 章·信创绕不开的三层压力，与三层技术栈的证据成色
...
% ═══════════════════════════════════════════════════════════════
% 比喻 1 · 西部片里的小镇布景（上册第 6 章 · 原型 vs 曳光弹）
% ═══════════════════════════════════════════════════════════════
...
% ═══════════════════════════════════════════════════════════════
% 比喻 3 · 错位的那一颗扣子（下册第 4 章 · 定长报文的静默错位）
% ═══════════════════════════════════════════════════════════════
...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \node[font=\scriptsize, text=fdmute, anchor=north west, align=left]
    ...
    {技能缩短的是左边那两段：不用先翻译成代码，也不用有人记得它存在。\\
     {\bfseries 右边那道门一寸没动}——它是上册 §14.2 第三级的入场条件。\\
...
% ═══════════════════════════════════════════════════════════════
% 图 · 上册第 2 章·这套方法论的完整来路（时代命题 → FDE → 方法论）
...
% ═══════════════════════════════════════════════════════════════
% 图 · 下册第 9 章·回流闭环：改写和故障怎么变成回归集
% 这张图画的是「验收集单调增长」这句话的机制。上册第 2 章把它当性质说，
