...
ITEMS = [
    ("01", "FDE 的终点不是做出来，而是用起来。", None,
     "验收签字那天项目没结束，那天只是开始计时。", "上册 §10.1", "提炼"),
    ("02", "这件事降低了哪一个不确定性？降不了，别做。", None,
     "空手说“不值得做”是拒绝干活，带着证据说才是产出物。", "上册 §2.1", "逐字"),
    ("03", "第一版不是小一点的完整产品，是最窄的一条真实业务路径。", None,
     "窄，但要真——真数据、真系统、真用户。", "上册 §6.1", "提炼"),
    ...
    ("06", "错了只是答不好的交给模型，错了要赔钱违法的必须交给代码。",
     "错了只是答不好，可以交给模型；\n错了要赔钱或违法，必须交给代码。",
     "而且“写进提示词”不算挡住——那是请求，不是约束。", "上册 §9.2", "提炼"),
    ...
    ("11", "模型可以换，“什么算对”不能跟着换。", None,
     "芯片、系统、数据库、模型全换一遍之后，还剩什么不用重建。", "下册 §9.0", "提炼"),
...
# 长图的骨架照上册第 2 章「整条链摊开」重排：时代命题（三步）→ FDE 公理
